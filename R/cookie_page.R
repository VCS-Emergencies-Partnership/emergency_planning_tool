cookie <- function() {
  fluidRow(
    column(
      ...
      tags$p(
        "You should read this Cookies Policy alongside our ", tags$a(href = "https://www.redcross.org.uk/privacy", target = "_blank", "privacy notice"), " and our ", tags$a(href = "https://www.redcross.org.uk/terms-and-conditions", target = "_blank", "terms and conditions"), "."
      ),
      tags$p(
        "If you would like further information on our use of cookies and similar technologies, please contact us at ", tags$a(href = "mailto:dataprotection@redcross.org.uk", "dataprotection@redcross.org.uk"), "."
      ),
      tags$h2(
        "1. What is a cookie?"
      ),
      ...
      tags$div(tags$ul(
        tags$li("Make our website work"),
        tags$li("Collect data on how users navigate our site, which helps us to improve it"),
        tags$li("Allow you to share our content on social networks"),
        tags$li("Help us provide relevant advertising to those who may be interested in it")
      )),
      tags$p(
        "We do not use cookies to:"
      ),
      tags$div(tags$ul(
        tags$li("Collect any personal data"),
        tags$li("Pass personal data to third parties")
      )),
      tags$p(
      ...
      tags$p(
        "For more information on cookies, please see the", tags$a(href = "https://ico.org.uk/your-data-matters/online/cookies/", target = "_blank", "Information Commissioner's Office information on cookies"), "."
      ),
      tags$h2(
      ...
      tags$div(tags$ul(
        tags$li("Strictly necessary cookies"),
        tags$li("Functional cookies"),
        tags$li("Performance cookies"),
        tags$li("Targeting cookies")
      )),
      tags$p(
      ...
      tags$div(tags$ul(
        tags$li("", tags$a(href = "https://support.google.com/accounts/answer/61416?co=GENIE.Platform=Desktop&hl=en", target = "_blank", "Google Chrome"), ""),
        tags$li("", tags$a(href = "https://privacy.microsoft.com/en-us/windows-10-microsoft-edge-and-privacy", target = "_blank", "Microsoft Edge"), ""),
        tags$li("", tags$a(href = "https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences", target = "_blank", "Mozilla Firefox"), ""),
        tags$li("", tags$a(href = "https://support.microsoft.com/en-gb/help/17442/windows-internet-explorer-delete-manage-cookies", target = "_blank", "Microsoft Internet Explorer"), ""),
        tags$li("", tags$a(href = "https://www.opera.com/help/tutorials/security/privacy/", target = "_blank", "Google Chrome"), ""),
        tags$li("Safari on ", tags$a(href = "https://support.apple.com/en-gb/guide/safari/sfri11471/mac", target = "_blank", "Mac"), " or ", tags$a(href = "https://support.apple.com/en-gb/HT201265", target = "_blank", "phone/tablet"), "")
      )),
      tags$p(
      ...
      tags$p(
        "To delete or review cookies that are on your device, you will need to go into the settings of your browser and review them. For more information about cookies, including how to set your internet browser to reject cookies, please go to ", tags$a(href = "https://www.allaboutcookies.org/", target = "_blank", "www.allaboutcookies.org"), ""
      ),
      tags$h2(
