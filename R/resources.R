resources_page <- function() {
  ...
  fluidRow(
    column(
      11,
      align = "left",
      tags$p("Here is a collection of useful publicly available insight resources that could be of use to the VCS community during a heatwave The resources shown are general resources. Other resources can be found on the ",
  ...
  flowLayout(
      box(title = "Met: Sign up to the Heat-health Alert Service", "The service forewarning you of periods of high temperatures.",
      ...
      box(title = "MET: Weather-health alerting system guide", "A guide to understanding the new impact-based weather-health alerting system.",
          width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
      ...
      box(title = "GOV: Heat-Health Alert action card for the VCS", "Action card summarising the suggested actions that the VCS should consider,", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
      ...
      box(title = "GOV: Hot weather and health", "Guidance on how to suppport vulnerable people.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
  ...
  column(
    11,
    align = "left",
    tags$p("As a result of a heatwave, the ground becomes dry and therefore flash flooding can occur.")
  ),
      flowLayout(
      ...
      box(title = "GOV: Flood alerts and warnings", "National flood warnings and alerts.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
      ...
      flowLayout(
      box(title = "NFCC: Wildfire Prevention", "Guidance and resources on wildfires.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
      ...
      flowLayout(
      box(title = "BRC: Heatwave advice", "Advice on how to cope with extreme heat.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
                              onclick ="window.open('https://www.redcross.org.uk/get-help/prepare-for-emergencies/heatwaves-uk', '_blank')")
      ),
      box(title = "BRC: Heatwave checklist", "A checklist for how to prepare before and during a heatwave.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
      ...
      box(title = "VCSEP: Heatwave TTX", "Report and resoruces from a capability exercise on heatwaves.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
                              onclick ="window.open('https://www.vcsep.org.uk/resources/heatwave-ttx-report-and-resources', '_blank')")
      ),
      box(title = "VCSEP: Heatwave scenario exercise", "Example heatwave scenarios that can be used for prepardness.", width = 18, height = 240, background = "purple",
          shiny::actionButton(inputId='ab1', label="Click here",
